	...
	loadImages: function(){
        ...
        return new Promise((resolve, reject) => {
            ...
            const files = [
                ...
                this.loadImage('facing_to_up_left', 'img/up-left.png'),
                this.loadImage('facing_to_up_right', 'img/up-right.png'),
                this.loadImage('facing_to_down_left', 'img/down-left.png'),
                this.loadImage('facing_to_down_right', 'img/down-right.png'),
